...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2016 at 02:41 PM
...
(1, 'Web Designer', 'Qualification: Candidate will be responsible for the website designing  with creative thinking and adopting latest webstandards.  Experience: 0 to 2 years experience in web designing.  Skillset: Web Designing, , HTML, CSS, Design Sense, JavaScript, Jquery,  Ajax, Flash Animation, Adobe Creative Suite. Familiarity with the basic concepts  of SEO/SEM as they apply to the design process.', 'Banglore', 7, 'employeer@somecompany.com', 'Full Time'),
(2, 'Data Scientist', 'Central Drug Research Institute has published the Latest Recruitment Notification 2020 and started inviting online applications to fulfil the 17 Scientist, Senior Scientist and Principal Scientist Vacancies. Candidates, who have done Post Graduation or Ph.D are eligible and may apply within the last date as noticed in the official notification. However, job seekers may grab the opportunity to acquire a job and hold a good position in a career.', 'Indore', 7, 'employeer@somecompany.com', 'Part Time'),
...
(3, 'Harshit', 'Singh', 2, 'harshit@jobportal.com', '123456');
